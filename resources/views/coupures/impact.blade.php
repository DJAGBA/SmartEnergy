    ...
    <div class="mt-10">
        ...
        $retours = collect(
            ...
            (object)[ 'user' => (object)['name' => 'Aminata B.'], 'zone' => (object)['nom' => 'Zone Sud'], 'note' => 4,
             ...
             (object)[
        'user' => (object)['name' => 'AHLO'],
        'zone' => (object)['nom' => 'Zone Sud'],
        'note' => 4,
        ...
        'created_at' => now()->subDays(1),
            ...
            (object)[
        'user' => (object)['name' => 'ABALO'],
        'zone' => (object)['nom' => 'Zone Est'],
        'note' => 5,
        ...
        @forelse($retours as $fb)
            <div class="bg-gray-50 border-l-4 border-green-400 p-4 rounded mb-4 shadow-sm">
